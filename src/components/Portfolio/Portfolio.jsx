...
const Portfolio = () => {
    ...
    const contentData = [
        ...
        {
            title: "AI Multi-Omics for Personalized Medical Treatment and Drug Discovery (Ongoing)",
            ...
            subtitle: "Tags: Multimodal AI, Bioinformatics, LLMs, Transformers, Machine Learning, Data Science",
            link: "https://github.com/EvanJayChou/AI_Personalized_Healthcare"
        },
        {
            title: "Spotify Statistics Website (Ongoing)",
            description: "To be filled",
            subtitle: "Tags: Full-Stack Web Development, Machine Learning, Data Engineering",
            link: "https://github.com/EvanJayChou/Spotify_Statistics_Website"
        },
        {
            title: "Autonomous Warehouse Robot Navigation and Item Sorting (Ongoing)",
            description: "To be filled",
            subtitle: "Tags: Robotics, Deep Reinforcement Learning, Computer Vision",
            link: "TBA"
        },
    ];
